		...
		if (index >= 0 && index < getItemsCount()) {
			...
			if (textView != null) {
				...
				if (index == currentIndex) {
					...
					textView.setTextColor(context.getResources().getColor(R.color.pickerview_topbar_title));
				} else {
					textView.setTextSize(minsize);
					textView.setTextColor(context.getResources().getColor(R.color.version2_0_common_defaultpay_notinternet_text_color));
				}
