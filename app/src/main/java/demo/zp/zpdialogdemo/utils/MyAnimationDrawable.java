...
/**
 * Created by mrma-pc on 2016/10/26.
 * 帧动画工具类
 */
public class MyAnimationDrawable {
    ...
    public static void animateRawManuallyFromXML(int resourceId,
        ...
        isStop=false;
        loadRaw(resourceId,new WeakReference<Context>(imageView.getContext()).get(),
...
//                            AresLog.e("MyaniDrawable","recyle");
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (imageView.getDrawable() == thisFrame.drawable) {
                    if (frameNumber + 1 < myFrames.size()&&!isStop) {
